...
package com.ethernom.psdmgr.mobile.autofill.model;

import static com.ethernom.psdmgr.mobile.autofill.data.source.local.DigitalAssetLinksRepository.getCanonicalDomain;
